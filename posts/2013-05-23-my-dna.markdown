...
I knew my mother's side was British before coming to America in the colonies. Seeing a tad of Native American and Aferican in there makes sense. I knew there was some Cherokee in there, so it was cool to see the results matched that. You can really drill down on this graph. Here's the overview though:

![Ancestory](http://assets.samsoff.es/posts/my-dna/ancestory.png)

This wasn't as interesting to me as the health/traits stuff, but still pretty interesting.
